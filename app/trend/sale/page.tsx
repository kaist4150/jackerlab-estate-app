...
import { TrendingUp, TrendingDown, Calendar, MapPin, Loader2, AlertCircle } from 'lucide-react';
...
export default function SaleTrendPage() {
  ...
  const stats = useMemo(() => {
    ...
    return { maxPrice, minPrice, totalChange, latestPrice };
  }, [chartData]);
    ...
    <div className="space-y-6">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900">매매가 추이</h1>
        </div>
        <p className="text-sm text-gray-500">지역별 아파트 매매가격 지수 변동 추이</p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-5">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-semibold text-gray-900">{selectedRegion} 아파트 매매가격 지수</h2>
              ...
              <div className="text-center text-sm text-gray-500 mt-2">
                한국부동산원 아파트 매매가격 지수 (2021.06 = 100)
              </div>
            </div>
