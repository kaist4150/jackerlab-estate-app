...
function parseXmlToItems(xml: string, district: string): ApartmentTrade[] {
  ...
  while ((match = itemRegex.exec(xml)) !== null) {
    ...
    const name = getValue('아파트') || getValue('aptNm');
    ...
    const year = getValue('년') || getValue('dealYear');
    const month = getValue('월') || getValue('dealMonth');
    const day = getValue('일') || getValue('dealDay');
